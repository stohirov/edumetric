...
public class GradeCategoryController {
    ...
    public ResponseEntity<ApiResponse<List<GradeCategoryDto>>> listByCourse(
            @RequestParam Long courseId,
            @AuthenticationPrincipal AuthenticatedUser principal) {
        return ResponseEntity.ok(ApiResponse.ok(gradeCategoryService.listByCourse(courseId, principal)));
    }
